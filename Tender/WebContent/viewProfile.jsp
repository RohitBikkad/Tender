	...
	%>
		...
		<table style="background-color:white">
		   ...
		   <tr><td style="color:black">	Company Name : </td><td> <%= vendor.getCompany()%></td></tr>
			<tr><td style="color:black" colspan="2" align="center" value="Launch"><a href="updateProfile.jsp" style="color:red">Click Here To Update Profile</a></td></tr>
