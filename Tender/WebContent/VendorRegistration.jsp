      ...
      <div class="container">
          ...
          <div class="row">
            ...
            <label class="label" for="name">Name</label>
              <input type="text" name="vname" class="form-control" id="vname" placeholder="Your name" pattern="[A-Za-z\s]{0,50}"  required>
            </div>
            ...
            <label class="label" for="name">Company</label>
              <input type="text" name="cname" class="form-control" id="cname" placeholder="Your Company Name" pattern="[A-Za-z\s]{0,50}" required>
            </div>
            <div class="col-md-6 form-group">
            <label class="label" for="name">Contact</label>
              <input type="number" name="vmob" class="form-control" id="vmob" placeholder="Your Mobile Number"  required>
            </div>
       ...
       <div class="text-center">
          <button type="submit" class="form-control btn btn-primary rounded submit px-3" style="width:150px;">Sign Up</button>
		 </div>   
